    ...
    <body>
        <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
            ...
            <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto" method ="get" >
                <a class="me-3 py-2 text-dark text-decoration-none" href="/api/authorization" >Вход/Авторизация</a>
            </nav>
        </div>
                    ...
                    <div class="row">
                        <div class="col-12" style="padding: 0;">
                            <div class="position-absolute text-center" style="top: 50%; left: 0; right: 0; transform: translateY(-50%);">
                                ...
                                <br>
                                Организация: <a  href="api/personals/${person.organization.id}">${person.organization.name}</a>
                                <br>
